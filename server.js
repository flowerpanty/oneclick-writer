...
function buildStep7WriterPrompt(payload) {
  return [
    ...
    "- 최종 본문은 HTML 형식으로도 함께 제공해야 하며 `H2`, `H3`, `p` 태그를 사용해 네이버 블로그 / 워드프레스 / 티스토리에 복붙 가능한 수준으로 정리할 것.",
    "- `htmlBody`는 위에서 쓴 `title`, `subtitle`, `intro`, `bodySections`, `closing`, `cta`, `hashtagsLine`만 같은 순서로 재배열한 최종 HTML이어야 한다.",
    "- 즉 `htmlBody`에 새로운 문장이나 위에 없는 설명을 새로 만들지 말고, 이미 쓴 내용을 HTML 태그로 합쳐 넣을 것.",
    "- `htmlBody`는 별도 새 글이 아니라 위 필드들을 합친 최종 출력본이다.",
    "",
    "[금지사항]",
