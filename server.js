...
- 본문 길이는 가능하면 공백 포함 약 800~1000자 정도로 맞춘다.
- 원문이 아주 짧으면 억지로 늘리지 말고 조금 짧아져도 되지만, 불필요하게 길어지지는 않게 한다.
- 400자 안팎의 짧은 메모처럼 끝내지 말고, 같은 사실 안에서 상황/감정/작업 흐름을 조금 더 풀어 쓴다.
- 톤은 너무 우울하거나 처지지 않게, 사부작하고 귀엽고 생기 있게 유지한다.
- 힘든 이야기라도 자기연민으로 길게 끌지 말고, 작은 웃음이나 생활감이 느껴지게 쓴다.
...
- 본문 길이는 가능하면 공백 포함 약 800~1000자 정도로 맞춘다.
- 400자 안팎의 짧은 메모 수준으로 끝내지 말고, 같은 사실 안에서 관찰/맥락/작업 포인트를 조금 더 남긴다.
- 기록성은 유지하되 분위기가 지나치게 무겁거나 글루미하지 않게, 담백하고 산뜻하게 쓴다.
- 문단은 3~4줄 내외로 작성한다.
- H1은 금지한다.
...
- 짧은 문장/대화체/적당한 이모지
- 사람/성장/시행착오가 보이게
- 분량은 가능하면 공백 포함 약 800~1000자로 유지
- 글루미하게 가라앉지 말고, 사부작한 생활감과 귀여운 리듬이 느껴지게
...
- 분량은 가능하면 공백 포함 약 800~1000자로 유지
- 분위기는 지나치게 무겁지 않게, 기록은 남기되 읽는 맛이 있게
