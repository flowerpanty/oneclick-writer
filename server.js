...
function buildResearchStrategyPrompt(payload) {
  return [
    ...
    "",
    "아래 `패션·잡화·IT 정보성 블로그 작성 최종 지침서`는 STEP 7의 다른 모든 조건보다 우선하는 최우선 규칙이다.",
    "이 지침과 다른 조건이 충돌하면 반드시 이 지침서를 먼저 따른다.",
    ...
    "",
    "[JSON 작성 규칙]",
    "- `featuredDraft` 안에 `title`, `subtitle`, `slug`, `metaDescription`, `tags`를 반드시 넣을 것.",
    "- `bodySections` 각 항목에는 `heading`, `subKeyword`, `productName`, `price`, `size`, `oneLineSummary`, `paragraphs`를 넣을 것.",
